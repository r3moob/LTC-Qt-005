...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(account1, &BankAccount::sigBalanceChanged, &logger, &Logger::logAccountChange);
    QObject::connect(account2, &BankAccount::sigBalanceChanged, &logger, &Logger::logAccountChange);
